<template>
  <div class="picker-slot" @touch :class="classNames" :style="classNames.indexOf('slot2') === -1 ? flexStyle : ''">
    <div v-if="!divider" ref="wrapper" class="picker-slot-wrapper" :class="{ dragging: dragging }" :style="{ height: contentHeight + 'px' }">
      <div class="picker-item" @click="pickerItem(itemValue)" v-for="itemValue in mutatingValues" :class="{ 'picker-selected': itemValue === currentValue }" :style="{ height: itemHeight + 'px', lineHeight: itemHeight + 'px' }">
...
export default {
  ...
  methods: {
    ...
    updateRotate: function (currentTranslate, pickerItems) {
      ...
      Array.prototype.forEach.call(pickerItems, (item, index) => {
